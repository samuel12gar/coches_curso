        ...
        http
                ...
                .authorizeHttpRequests(requests ->
                        requests
                                ...
                                //.requestMatchers(HttpMethod.POST,"/customers").hasAnyRole(Roles.CUSTOMER, Roles.ADMIN)
                                .requestMatchers(HttpMethod.GET, "/customers/**").hasAnyRole(Roles.CUSTOMER, Roles.ADMIN)
                                //.requestMatchers("/customers").hasAuthority(Roles.CUSTOMER)
                                .requestMatchers("/customers").hasRole(Roles.CUSTOMER)
                                //.requestMatchers("/customers").hasAuthority(Roles.CUSTOMER)
